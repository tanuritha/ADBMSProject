...
int RBFTest_Delete(RecordBasedFileManager *rbfm)
{
	...
	RID rid3 = rid;
	assert(rc == success && "Inserting a record should not fail.");
    // @todo: Temp code for testing scan iterator. Please delete once not required.
    //    void *value = malloc(25);
//    *(unsigned *)((char *)value) = 25;
//    vector<string> fetchAttribs;
//    fetchAttribs.push_back("EmpName");
//    fetchAttribs.push_back("Height");
//    RBFM_ScanIterator rscan;
//    rbfm->scan(fileHandle, recordDescriptor, "Age", EQ_OP, value, fetchAttribs, rscan);
