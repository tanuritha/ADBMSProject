...
int RBFTest_8b(RecordBasedFileManager *rbfm) {
    ...
    RC rc;
    string fileName = "test_readAttrib";

    // Create a file named "test_readAttrib"
    ...
    rbfm->readAttribute(fileHandle, recordDescriptor, rid, "EmpName", returnedData2);
   if(memcmp("Anteater", returnedData2, 8) !=0)
   {
       cout << "Fail";
       return -1;
   }
    ...
    // Close the file "test_readAttrib"
